/* 2. Realizar un programa que lea un arreglo de estructuras los datos de N empleados de la empresa y
...
int main(){
	...
	for(int i=0; i<n_empleados; i++){
		fflush(stdin); // Vacias el buffer y poder digitar más valores
		cout<<"Nombre: ";
